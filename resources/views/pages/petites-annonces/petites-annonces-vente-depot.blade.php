...
@section('title', 'Déposer une annonce de vente')
...
@section('content')
    ...
    <div class="container">
        ...
        <div class="back-button">
            <a href="{{ route('petites-annonces.vente') }}" class="btn-back">← Retour aux annonces</a>
        </div>
        ...
        <section class="form-section">
            <div class="form-container">
                ...
                <form action="{{ route('petites-annonces.vente.store') }}" method="POST" enctype="multipart/form-data" class="annonce-form">
                    @csrf
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('petites-annonces.vente') }}" class="btn btn-cancel">Annuler</a>
                    </div>
                </form>
            </div>
