...
@section('title', 'Qui sommes-nous - APEEAC')
...
<div class="container">
    <section class="content-box">
        ...
        <p>Avec plus de 150 familles adhérentes, nous sommes un acteur incontournable de la vie du conservatoire. Notre force réside dans l'engagement de nos bénévoles et la qualité de nos échanges avec la direction et les enseignants.</p>
    </section>
    ...
    <section class="content-box cta-section">
        ...
        <a href="{{ route('adherer') }}" class="btn">Devenir adhérent</a>
        <a href="{{ route('benevole') }}" class="btn btn-secondary">Devenir bénévole</a>
    </section>
</div>
@endsection