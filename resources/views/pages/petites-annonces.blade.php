...
@section('title', 'Petites Annonces - APEEAC')
    ...
    <div class="container">
        ...
        <section class="categories-section">
            ...
            <div class="categories-grid">
                ...
                <!-- Bulle "Je vends" -->
                <a href="{{ route('petites-annonces.vente') }}" class="category-bubble vente-bubble">
                ...
                <!-- Bulle "Je recherche" -->
                <a href="{{ route('petites-annonces.recherche') }}" class="category-bubble recherche-bubble">
                    <div class="bubble-icon">🔍</div>
                    <h3>Je recherche</h3>
                ...
                <!-- Bulle "Covoiturage" -->
                <a href="{{ route('petites-annonces.covoiturage') }}" class="category-bubble covoiturage-bubble">
                    <div class="bubble-icon">🚗</div>
                    <h3>Covoiturage</h3>
