...
<?php $__env->startSection('title', 'Conservatoire'); ?>
...
<div class="container">
    ...
    <aside class="sidebar-nav">
        ...
        <nav class="sidebar-menu">
            <a href="#infos-pratiques" class="sidebar-link">
                <span class="sidebar-icon">📍</span>
                <span class="sidebar-text">Informations pratiques</span>
            </a>
            <a href="#cursus" class="sidebar-link">
                <span class="sidebar-icon">🎓</span>
                <span class="sidebar-text">Les cursus</span>
            </a>
            <a href="#cycles" class="sidebar-link">
                <span class="sidebar-icon">🔄</span>
                <span class="sidebar-text">Les cycles</span>
            </a>
            <a href="#orchestres" class="sidebar-link">
                <span class="sidebar-icon">🎼</span>
                <span class="sidebar-text">Orchestres & ensembles</span>
            </a>
            <a href="#lien-site" class="sidebar-link">
                <span class="sidebar-icon">🌐</span>
                <span class="sidebar-text">Site officiel</span>
            </a>
            <a href="#contact" class="sidebar-link">
                <span class="sidebar-icon">📞</span>
                <span class="sidebar-text">Contact rapide</span>
            </a>
        </nav>
    </aside>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\apeeac-main (2)\apeeac-main\resources\views/pages/conservatoire.blade.php ENDPATH**/ ?>