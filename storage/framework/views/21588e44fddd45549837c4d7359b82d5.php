...
<?php $__env->startSection('title', 'Déposer une demande de recherche'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <div class="back-button">
            <a href="<?php echo e(route('petites-annonces.recherche')); ?>" class="btn-back">← Retour aux demandes</a>
        </div>
        ...
        <section class="form-section">
            <div class="form-container">
                ...
                <form action="<?php echo e(route('petites-annonces.recherche.store')); ?>" method="POST" class="annonce-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="<?php echo e(route('petites-annonces.recherche')); ?>" class="btn btn-cancel">Annuler</a>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\apeeac14\apeeac-main\resources\views/pages/petites-annonces-recherche-depot.blade.php ENDPATH**/ ?>