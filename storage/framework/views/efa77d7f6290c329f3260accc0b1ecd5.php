...
<?php $__env->startSection('title', 'Covoiturage - Petites Annonces'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <div class="back-button">
            <a href="<?php echo e(route('petites-annonces')); ?>" class="btn-back">← Retour aux petites annonces</a>
        </div>

        <!-- Bouton proposer un trajet -->
        <section class="deposit-section">
            <a href="<?php echo e(route('petites-annonces.covoiturage.create')); ?>" class="btn btn-deposit">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\apeeac14\apeeac-main\resources\views/pages/petites-annonces-covoiturage.blade.php ENDPATH**/ ?>