...
<?php $__env->startSection('title', 'Proposer un trajet de covoiturage'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <div class="back-button">
            <a href="<?php echo e(route('petites-annonces.covoiturage')); ?>" class="btn-back">← Retour aux trajets</a>
        </div>
        ...
        <section class="form-section">
            <div class="form-container">
                ...
                <form action="<?php echo e(route('petites-annonces.covoiturage.store')); ?>" method="POST" class="annonce-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="<?php echo e(route('petites-annonces.covoiturage')); ?>" class="btn btn-cancel">Annuler</a>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\apeeac14\apeeac-main\resources\views/pages/petites-annonces-covoiturage-depot.blade.php ENDPATH**/ ?>