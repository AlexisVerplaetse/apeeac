...
<div class="container">
    ...
    <aside class="sidebar-nav">
        ...
        <nav class="sidebar-menu">
            <a href="#bureau" class="sidebar-link">
                ...
                <span class="sidebar-text">Bureau</span>
            </a>
            <a href="#assemblees-generales" class="sidebar-link">
                <span class="sidebar-icon">🏛️</span>
                <span class="sidebar-text">Assemblées Générales</span>
            </a>
            <a href="#reunions-bureau" class="sidebar-link">
                <span class="sidebar-icon">📋</span>
                <span class="sidebar-text">Réunions de bureau</span>
            </a>
            <a href="#documents-comptables" class="sidebar-link">
                <span class="sidebar-icon">💰</span>
                <span class="sidebar-text">Documents comptables</span>
            </a>
            <a href="#adhesions" class="sidebar-link">
                <span class="sidebar-icon">👥</span>
                <span class="sidebar-text">Adhésions</span>
            </a>
            <a href="#modeles-outils" class="sidebar-link">
                <span class="sidebar-icon">🛠️</span>
                <span class="sidebar-text">Modèles et outils</span>
            </a>
            <a href="#assurances" class="sidebar-link">
                <span class="sidebar-icon">🛡️</span>
                <span class="sidebar-text">Assurances</span>
            </a>
            <a href="#contacts-utiles" class="sidebar-link">
                <span class="sidebar-icon">📞</span>
                <span class="sidebar-text">Contacts utiles</span>
            </a>
        </nav>
    </aside>
    ...
    <section id="assemblees-generales" class="content-box">
    ...
    <section id="reunions-bureau" class="content-box">
    ...
    <section id="documents-comptables" class="content-box">
    ...
    <section id="adhesions" class="content-box">
    ...
    <section id="modeles-outils" class="content-box">
    ...
    <section id="assurances" class="content-box">
        <h2>Assurances</h2>
    ...
    <section id="contacts-utiles" class="content-box">
